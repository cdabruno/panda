...
const char *gengetopt_args_info_help[] = {
  ...
  "  -Q, --taskSequenceHash     disable task sequence hashing [default=with task\n                               sequence hash]  (default=on)",
  "  -O, --topologicalOrdering  disable visited checking with task sequences, this\n                               makes totally-ordered visited lists incomplete\n                               [default=with order]  (default=on)",
  ...
  "  -P, --pruning=STRING       pruning mode  (possible values=\"none\", \"ff\",\n                               \"h2\" default=`ff')",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->progression_help = gengetopt_args_info_help[10] ;
  args_info->sat_help = gengetopt_args_info_help[11] ;
  args_info->bdd_help = gengetopt_args_info_help[12] ;
  args_info->interactive_help = gengetopt_args_info_help[13] ;
  args_info->heuristic_help = gengetopt_args_info_help[15] ;
  args_info->heuristic_min = 0;
  args_info->heuristic_max = 0;
  args_info->astarweight_help = gengetopt_args_info_help[16] ;
  args_info->gValue_help = gengetopt_args_info_help[17] ;
  args_info->suboptimal_help = gengetopt_args_info_help[18] ;
  args_info->noVisitedList_help = gengetopt_args_info_help[20] ;
  args_info->taskHash_help = gengetopt_args_info_help[21] ;
  args_info->taskSequenceHash_help = gengetopt_args_info_help[22] ;
  args_info->topologicalOrdering_help = gengetopt_args_info_help[23] ;
  args_info->noLayers_help = gengetopt_args_info_help[24] ;
  args_info->noOrderPairs_help = gengetopt_args_info_help[25] ;
  args_info->noParallelSequences_help = gengetopt_args_info_help[26] ;
  args_info->noGIcheck_help = gengetopt_args_info_help[27] ;
  args_info->blockcompression_help = gengetopt_args_info_help[29] ;
  args_info->satmutexes_help = gengetopt_args_info_help[30] ;
  args_info->pruning_help = gengetopt_args_info_help[31] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hdS:t:NpsbIH:w:g:VTQOBMP:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "suboptimal") == 0)
          {
