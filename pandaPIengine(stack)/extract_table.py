    ...
    for domain in range(len(domains)):
        ...
        for p in list_problems:
            ...
            for line in handler:
                ...
                pos9 = line.find('Cost of SAS plan on RC model: ')
                ...
                sas_plan_pos = line[pos9: pos9 + 40]
                ...
                if line.startswith("Cost of SAS plan on RC model: "):
                    sas_plan_line = line.split()
                    sas_plan_var = sas_plan_line[7]
                    sas_plan[p + "/" + path] = sas_plan_var
...
with open('results/statistics/table_lmCut_vs_new_heuristics.csv', 'w') as csv_file:
    ...
    for domain in range(len(domains)):       
        ...
        writer.writerow([""]+["num_variables", "num_primitive_tasks", "num_non_primitive_tasks", "total_tasks", "num_methods", "initial_heuristic", "expanded_nodes", "solution_length", "sas_plan_cost"])
