...
//    Heuristic *hLMC = new hhLMCount(htn, 0, tnI, lmfFD);
	...
	if (algo == INTERACTIVE){
		...
		//search.search(htn, tnI, timeL, suboptimalSearch, printPlan, heuristics, hLength, visi, fringeStack, 1, 0, 0, 0);
		
		// UNCOMMENT THIS FOR STACK SEARCH WITH MOVE-ORDERING
		//search.search(htn, tnI, timeL, suboptimalSearch, printPlan, heuristics, hLength, visi, fringeStack, 1, 1, 0, 0);

		// UNCOMMENT THIS FOR REGULAR PROGRESSION SEARCH 
		//search.search(htn, tnI, timeL, suboptimalSearch, printPlan, heuristics, hLength, visi, fringe, 0, 1, 0, 0);

		// UNCOMMENT THIS FOR ALG 1 (A*) 
		search.search(htn, tnI, timeL, suboptimalSearch, printPlan, heuristics, hLength, visi, fringe, 0, 1, 0, 1);

		//search.search(htn, tnI, timeL, suboptimalSearch, printPlan, heuristics, hLength, visi, fringeStack, 1, 1, 1, 0);

		//search.search(htn, tnI, timeL, suboptimalSearch, printPlan, heuristics, hLength, visi, fringeStack, 1, 0, 1, 0);

		//search.search(htn, tnI, timeL, suboptimalSearch, printPlan, heuristics, hLength, visi, fringe, 0, 1, 1, 0);
